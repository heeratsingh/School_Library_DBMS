 ...
 */
public class Publisher_Search extends javax.swing.JFrame {

    /**
     * Creates new form Publisher_Search
     */
...
jTable1.clearSelection();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search for Publishers :");
        ...
        jLabel2.setText("Publisher Number :");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Publisher Number", "Publisher", "Books In Library"
            }
        ) {
...
String publisherno=jTextField1.getText().trim();
String publishername=jTextField2.getText().trim();
try
{
c=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","1234");
smt= c.createStatement();
String query="";
if(publisherno.matches(""))
{
query= "select publisher.publisher_no,publisher_name,count(name_book) from publisher,book where publisher.publisher_no=book.publisher_no and Publisher_Name like \"%"+publishername+"%\" group by book.publisher_no";
}
else if(publishername.matches(""))
{
query= "select publisher.publisher_no,publisher_name,count(name_book) from publisher,book where publisher.publisher_no=book.publisher_no and publisher.Publisher_No='"+publisherno+"' group by book.publisher_no;";
}
...
{       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Publisher_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Publisher_Search().setVisible(true);
            }
        });
    }
