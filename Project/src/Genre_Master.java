 ...
 */
public class Genre_Master extends javax.swing.JFrame {

    /**
     * Creates new form Genre_Master
     */
    public Genre_Master() {
        initComponents();
...
String query= "select genere_no,genere from genere order by genere_no";
...
String genrename=jTextField1.getText();
String genreno=jTextField2.getText();
try
 {
c=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","1234");
stmt= c.createStatement();
String query="insert into genere values('"+genreno+"','"+genrename+"');";
...
c=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","1234");
stmt= c.createStatement();
String query="delete from genere where genere_no="+genreno+";";
stmt.executeUpdate(query);
...
c=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","1234");
stmt= c.createStatement();
String query="update genere set genere= '"+genrename+"' where genere_no='"+genreno+"';";
stmt.executeUpdate(query);
...
resetting();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Genre_Master.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Genre_Master().setVisible(true);
            }
        });
    }
